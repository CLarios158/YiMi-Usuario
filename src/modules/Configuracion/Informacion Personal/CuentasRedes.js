                    ...
                    <Grid>
                            ...
                            <Col>
                                <ListItem>
                                    ...
                                    {this.state.statusFacebook == 0
                                        ...
                                        ? <Text onPress={this.alertFacebook}>Conectado</Text>
                        ...
                        <Row>
                            <Col>
                                <ListItem>
                                    <Left>
                                        <Thumbnail source= {require('../../../image/google.png')} style={{height:20, width:20}}/>
                                        <Text> Google</Text>
                                    </Left>
                                    {this.state.statusGoogle == 0
                                        ? <Text>Conectarse</Text>
                                        : this.state.statusGoogle == 1 
                                        ? <Text onPress={this.alertGoogle}>Conectado</Text>
                                        : <Text>Desconectado</Text>
                                    }
                                    <Right>
                                        <Button onPress={this.signInGoogle} transparent style={{height:30}}><Icon style={{color:'black'}} name="arrow-forward" /></Button>
                                    </Right>
                                </ListItem>
                            </Col>
                        </Row>
